...
SoftwareSerial sim800l(1, 0); // RX,TX for Arduino and for the module it's TXD RXD, they should be inverted
...
void SendSMS()
{
  ...
  delay(100);
  sim800l.print("AT+CMGS=\"+639394575828\"\r");  //Your phone number don't forget to include your country code, example +212123456789"
  delay(500);
  sim800l.print("EARTHQUAKE DETECTED");       //This is the text to send to the phone number, don't make it too long or you have to modify the SoftwareSerial buffer
  delay(500);
